      ...
      <footer className="bg-[#45474B] text-gray-400 py-20">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-start px-6">
          <div>
            ...
            <ul className="cursor-pointer text-white font-bold">
          ...
          <div>
            <h3 className="text-teal-400 text-xl mb-4 font-bold">Quick Links</h3>
            <ul className="cursor-pointer text-white font-bold">
          ...
          <div>
            ...
            <ul className="cursor-pointer text-white font-bold">
              <li className="mb-6">
                ...
                <a href="mailto:info@ipctool.com" className="text-gray-100">
                  info@ipctool.com
                </a>
              </li>
              <li>
                <span className="font-bold">Phone:</span>{" "}
                <a href="tel:+923018844349" className="text-gray-100">
                  +92-301-8844349
                </a>
              </li>
              <li className="mt-5">
                ...
                <a className="text-gray-100">
                  ...
                  <br className="mt-6"></br> Jaranwala, Punjab, Pakistan
                </a>
              </li>
            </ul>
          </div>
